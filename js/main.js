...
const translations = {
  "fr": {
    ...
    "project_edupulse_desc": "Une plateforme de blogging moderne, ultra-rapide et minimaliste, conçu pour permettre aux étudiants de publier leurs travaux, expériences et cursus.",
    "project_quoteforge_tag": "Application web",
    "project_quoteforge_desc": "Générateur de devis professionnel permettant de créer, personnaliser et gérer des devis en ligne avec une interface moderne et intuitive.",
    "project_anam_tag": "Application multiplateforme",
    "project_anam_desc": "Plateforme moderne pour le suivi des données météorogiques en temps réel.",
    "edu_badge": "Formation",
  ...
  "en": {
    ...
    "project_edupulse_desc": "A modern, ultra-fast and minimalist blogging platform designed to allow students to publish their work, experiences, and curriculum.",
    "project_quoteforge_tag": "Web Application",
    "project_quoteforge_desc": "Professional quote generator for creating, customizing and managing online quotes with a modern and intuitive interface.",
    "project_anam_tag": "Multi-platform Application",
    "project_anam_desc": "Modern platform for real-time monitoring of meteorological data.",
    "edu_badge": "Education",
